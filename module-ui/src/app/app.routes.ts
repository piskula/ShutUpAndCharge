...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: async() => await import('./non-authenticated/non-authenticated.module').then(m => m.NonAuthenticatedModule),
  },
  {
    path: ROUTE_PREFIX_AUTH,
    canActivate: [isLoggedIn],
    loadChildren: async() => await import('./authenticated/authenticated.module').then(m => m.AuthenticatedModule),
  },
  {
    path: '**',
