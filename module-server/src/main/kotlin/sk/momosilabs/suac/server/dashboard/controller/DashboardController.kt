...
class DashboardController(
    ...
    override fun getMonthlySummary(pageable: PageableDTO): PageDTO<MonthlyTransactionSummaryDTO> =
        getMonthlySummary.get(pageable.toModel())
            .toDto(MonthlyTransactionSummary::toDto)
